...
{
    public partial class Approve_Thesis_PM : Form
    {
        public Approve_Thesis_PM()
        {
            InitializeComponent();
        }
            ...
            using (SqlConnection connection = new SqlConnection("Data Source=DESKTOP-3TMHGIH\\MSSQLSERVER01;Initial Catalog=project;Integrated Security=True"))
            {
                try
                {
                    ...
                    string insertQuery = "INSERT INTO Review (Comments, Evaluation, Approval, ThesisProposalID) " +
                                         "VALUES (@Comments, @Evaluation, 1, @ThesisProposalID)";
                    ...
                    using (SqlCommand insertCommand = new SqlCommand(insertQuery, connection))
                    {
                        ...
                        string updateQuery = "UPDATE ThesisProposal SET Approved = 1 WHERE ThesisProposalID = @ThesisProposalID";
